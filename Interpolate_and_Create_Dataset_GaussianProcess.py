...
data_features, labels_list, hostgal_specz_list, hostgal_photoz_list = [], [], [], []
...
hostgal_specz_list = np.array(hostgal_specz_list).reshape( (-1,1) )
hostgal_photoz_list = np.array(hostgal_photoz_list).reshape( (-1,1) )
...
X_val, Y_val, specz_val, photoz_val = data_features[size_training:size_training+size_validation], labels_list[size_training:size_training+size_validation], hostgal_specz_list[size_training:size_training+size_validation], hostgal_photoz_list[size_training:size_training+size_validation]

X_test, Y_test, specz_test, photoz_test = data_features[size_training+size_validation:], labels_list[size_training+size_validation:], hostgal_specz_list[size_training+size_validation:], hostgal_photoz_list[size_training+size_validation:]

print(X_training.shape, Y_training.shape, specz_training.shape, photoz_training.shape)
print(X_val.shape, Y_val.shape, specz_val.shape, photoz_val.shape)
...
hf.create_dataset( "specz_training", data = specz_training )
hf.create_dataset( "photoz_training", data = photoz_training )

hf.create_dataset( "X_val", data = X_val )
hf.create_dataset( "Y_val", data = Y_val )
hf.create_dataset( "specz_val", data = specz_val )
hf.create_dataset( "photoz_val", data = photoz_val )

hf.create_dataset( "X_test", data = X_test )
hf.create_dataset( "Y_test", data = Y_test )
hf.create_dataset( "specz_test", data = specz_test )
hf.create_dataset( "photoz_test", data = photoz_test )
